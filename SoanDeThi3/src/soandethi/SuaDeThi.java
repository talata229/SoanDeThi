 ...
 * @author Quan
 */
public class SuaDeThi extends javax.swing.JFrame {
    ...
    public ArrayList<CauHoi> dsCauHoiDeThi;
    public DefaultListModel<String> dlCauHoiDeThi;
    int n;
...
//        this.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
    ...
    private void initComponents() {
        ...
        btnChonNgauNhien.setBackground(new java.awt.Color(255, 204, 102));
        btnChonNgauNhien.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        rdTatCa.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        btnThemCauHoi.setBackground(new java.awt.Color(153, 153, 255));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtDiem, javax.swing.GroupLayout.DEFAULT_SIZE, 66, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jLabel11.setText("<HTML><U>Xuất ra file</U></HTML>");
        ...
        jLabel13.setText("<HTML><U>Xáo trộn các câu hỏi</U></HTML>");
    ...
    private void rdTuLuanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rdTuLuanMouseClicked
        ...
        for (int i = soCauTracNghiem; i<dsCauHoiTongHop.size(); i++) {
            TuLuan tl = (TuLuan) dsCauHoiTongHop.get(i);
             dlCauHoiMonHoc.addElement((i+1-soCauTracNghiem)+". " +tl.getNoiDungCauHoi());
        }
    ...
    public javax.swing.JList<String> listCauHoiDeThi;
    public static javax.swing.JList<String> listCauHoiMonHoc;
    public javax.swing.JRadioButton rdHocKy1;
    public javax.swing.JRadioButton rdHocKy2;
    public javax.swing.JRadioButton rdHocKyHe;
    ...
    public javax.swing.JTextArea txtChiTietDeThi;
    private javax.swing.JTextField txtDiem;
    public javax.swing.JTextField txtNamHoc;
    public javax.swing.JTextField txtPhut;
        ...
        for(int i = 0; i < dsCauHoiDeThi.size(); i++){
            ...
            if(ch instanceof TracNghiem){
                ...
                if(dsDapAnTracNghiem.size()>1){
                    ...
                    int daDao = 0;
                    int random = 0;
                    ArrayList<Integer> lda = new ArrayList<>();
                    
                    do{
                        for(int j = 0; j<dsDapAnTracNghiem.size();){
                            random = rd.nextInt(dsDapAnTracNghiem.size());
                            if(!lda.contains(random)){
...
//                ((TracNghiem) ch).setDsDapAn(dsDapAnTracNghiem);
